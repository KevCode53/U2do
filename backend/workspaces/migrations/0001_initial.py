# Generated by Django 3.2 on 2023-04-04 14:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bg_image', models.ImageField(upload_to='workspaces/background')),
                ('bg_color', models.CharField(max_length=500)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colaborators', models.ManyToManyField(to='users.Profile')),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_byworkspaces_workspace_related', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_byworkspaces_workspace_related', to=settings.AUTH_USER_MODEL, verbose_name='Updated by')),
            ],
            options={
